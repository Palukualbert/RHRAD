  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pages/views/login.php"> Login </a></li>
          <li class="nav-item"> <a class="nav-link" href="pages/views/register.php"> Register </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="error">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="pages/views/error-404.php"> 404 </a></li>
          <li class="nav-item"> <a class="nav-link" href="pages/views/error-500.php"> 500 </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
              ...
              <div class="col-md-6 grid-margin transparent">
                <div class="row">
                  <div class="col-md-6 mb-4 stretch-card transparent">
                        <a  href="../src/pages/views/ASG.php">
                            <button type="button" class="btn btn-outline-info" style="height: 200px;width: 220px;font-size: 22px;text-align: left; font-family: 'Times New Roman';border : double">REMUNERATION</button>
                        </a>
                  </div>
                  <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="col-md-6 mb-4 stretch-card transparent">
                          <a  href="../src/pages/views/ASG.php">
                              <button type="button" class="btn btn-outline-info" style="height: 200px;width: 220px;font-size: 22px;text-align: left; font-family: 'Times New Roman';border : double">RETRAITE ET CONGE</button>
                          </a>
                      </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                      <div class="col-md-6 mb-4 stretch-card transparent">
                          <a  href="../src/pages/views/ASG.php">
                              <button type="button" class="btn btn-outline-info" id="disabled-button" style="height: 200px;width: 220px;font-size: 22px;text-align: left; font-family: 'Times New Roman';border : double;" disabled>MISE EN PLACE</button>
                          </a>
                      </div>
                  </div>
                  <div class="col-md-6 stretch-card transparent">
                      <div class="col-md-6 mb-4 stretch-card transparent">
                          <a  href="../src/pages/views/ASG.php">
                              <button type="button" class="btn btn-outline-info" style="height: 200px;width: 220px;font-size: 22px;text-align: left; font-family: 'Times New Roman';border : double">RECHERCHE</button>
                          </a>
                      </div>
                  </div>
                </div>
