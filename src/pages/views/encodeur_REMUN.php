                        ...
                        <div class="card" style="flex: 1; display: flex; flex-direction: column;">
                            <div class="card-body" style="flex: 1; display: flex; flex-direction: column;">
                                ...
                                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                    ...
                                    $grade = $_POST['grade'];
                                    $nombre_jours_prestes = $_POST['nb_jours_preste'];
                                    $salaire_mensuel = $_POST['salaire_mensuel'];
                                    $resultat = $traitement->calculerPrime($matricule, $grade, $nombre_jours_prestes, $salaire_mensuel);
                                    $prime = $resultat['prime'];
                                }
                                    ...
                                    <table class="table table-striped" style="width: 100%;">
                                        ...
                                        <?php foreach ($searchResults as $employe): ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    if (isset($resultat) && $employe['Matricule'] === $resultat['matricule']) {
                                                        echo htmlspecialchars($resultat['prime']);
                                                    }
                                                    ?></td>
                                            </tr>
                                        <?php endforeach; ?>
