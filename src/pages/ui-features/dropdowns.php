  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"><a class="nav-link" href="../forms/basic_elements.php">Basic Elements</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="icons">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="../icons/mdi.php">Mdi icons</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="error">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="../views/error-404.php"> 404 </a></li>
          <li class="nav-item"> <a class="nav-link" href="../views/error-500.php"> 500 </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
